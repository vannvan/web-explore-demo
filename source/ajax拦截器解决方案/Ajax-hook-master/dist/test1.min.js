!(function (t) {
      ...
      (t.hookAjax = function (t) {
        ...
        function r(n) {
          return function () {
            ...
            if (!t[n] || !t[n].call(this, e, this.xhr))
              return this.xhr[n].apply(this.xhr, e);
          };
        }
        return (
  ...
  function (t, n, e) {
    ...
    o.hookAjax({
      onload: function (t) {
        console.log(t.getResponseHeader("token")),
          console.log("content-type:", t.getResponseHeader("Content-type"));
      },
      send: function (t, n) {
        n.setRequestHeader("token", "ahaha");
      },
    });
  },
]);
